...
- [ ] Phase 3b: KiCad board source — **spec written 2026-09-26, `specs/kicad_board_link.md`** (increments C1–C5; assessment `docs/kicad_board_link_assessment.md`); none landed yet

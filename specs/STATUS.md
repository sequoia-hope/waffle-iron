...
| 10 | `extrude_alignment_bugfix.md` | Extrude Alignment Bug Fix | Implemented | `feature-engine/src/rebuild.rs`, `app/.../sketchCoords.js` | Coordinate system fix |
| 11 | `k8_loops_store_aabb.md` | K8: Degenerate Wire Filter + AABB Culling | Complete | `vendor/truck/.../loops_store/mod.rs` | Sprint 36 |
| 12 | `lazy_exact_escalation.md` | Lazy Exact Escalation for Predicates | Implementing | `vendor/truck/.../integrate/mod.rs`, `.../winding.rs`, `.../robust_classify.rs` | Phase C |
...
| 21 | `topology_first_assembly.md` | Topology-First Shell Assembly | Implemented | `vendor/truck/.../integrate/mod.rs`, `.../radial_assembly.rs` | Sprint 48 |
| 22 | `wasm_panic_recovery.md` | WASM Panic Recovery | Implementing | `wasm-bridge/src/wasm_api.rs`, `kernel-fork/src/truck_kernel.rs` | FIP Section 3 |

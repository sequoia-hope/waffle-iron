...
|---|---------|---------|------------|-------------|--------|
| 01 | kernel | Clean-sheet B-Rep geometry kernel | Rust | None | In progress (951 tests, 27 ignored; assay 190 cases) |

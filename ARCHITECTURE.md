...
|---|---------|---------|------------|-------------|--------|
| 01 | kernel | Clean-sheet B-Rep geometry kernel | Rust | None | In progress (900 tests, 8 ignored; assay 190 cases) |
...
The clean-sheet kernel (`crates/kernel/`) is under active development. **900 kernel tests pass** (8 ignored). 190-case randomized assay corpus (seed 42) with analytical ground truth and Euler characteristic oracles.

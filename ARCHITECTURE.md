...
|---|---------|---------|------------|-------------|--------|
| 01 | kernel | Clean-sheet B-Rep geometry kernel | Rust | None | In progress (926 tests, 11 ignored; assay 190 cases) |
...
The clean-sheet kernel (`crates/kernel/`) is under active development. **912 kernel tests pass** (11 ignored). 190-case randomized assay corpus (seed 42) with analytical ground truth and Euler characteristic oracles.
...
1. **Yang hybrid boolean pipeline** — Phases 1–3 complete (bijective tessellation, exact mesh boolean, topology extraction; last commit `04de9d7` 2026-03-31). Next: Phase 4 (SSI refinement) and Phase 5 (switchover). See `specs/yang_hybrid_migration.md`

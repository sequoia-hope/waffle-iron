...
|---|---|---|---|---|
| R0032 | Stage 6 `reassembled output would be non-2-manifold` (76.6–81.5 s) | `s4-shell-euler`: shell root 1329 has χ = 4 (v = 1143, e = 3435, f = 2296) with NINE double-cover edges (each `fwd=2 rev=2`) among one vertex cluster 337–347 (+ 971–975) near (−137, 110, −170) — `(337,341) (337,342) (339,343) (339,346) (341,343) (342,345) (344,346) (344,347) (345,347)` — covered by two triangle sets (522–536 and 1491–1528): the same double-cover signature as the 2026-08-19 Stage-6 census row (then attributed torus A × cones B191/B192, a torus × two-cone junction). Face attribution of today's cluster is UNMEASURED | PROBE (site + signature measured; faces not yet attributed) | P3a-#146 corner-junction double cover (the 2026-08-19 census row's class) |

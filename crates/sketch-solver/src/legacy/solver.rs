...
use super::entity_mapping::SketchToSlvs;
use crate::profiles::extract_profiles;
use super::status::classify_status;
use crate::types::{Sketch, SolveStatus, SolvedSketch};

/// Legacy solver: solve a sketch using libslvs (SolveSpace).
/// Dev-only oracle for parity validation against the clean-room solver.
pub fn legacy_solve_sketch(sketch: &Sketch) -> SolvedSketch {

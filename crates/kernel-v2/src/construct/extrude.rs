//! Extrude family — lamina, linear sweep (polygon/arc/circle profiles), and
//! the boundary/hole lamina + geometry helpers. Move-only split from the
//! construct god-module (design review 2026-07-12 F9); byte-identical.
